...
// buySellModConfig contains the configuration params for this strategy
type buySellModConfig struct {
...
func makeBuySellModStrategy(
	...
	sellSideStrategy := makeSellSideStrategy(
		...
		assetBase,
		assetQuote,
		makeDynamicSpreadLevelProvider(
			config.Levels,
